		...
		<>
				...
				<div className="card">
					<div className="card-content">
						...
						<h3 className="card-description">
							...
							empresas, através da adequação do ambiente de trabalho às normas
			...
			<div className="textContent">
				<p className="quemsomos-text">
					...
					Andradas, Minas Gerais – MG, sede própria. Sua equipe técnica é
					formada por Técnicos de Segurança do Trabalho, Engenheiros de
					Segurança do Trabalho e Médicos do Trabalho. Dispõe de todos os
				...
				<p className="quemsomos-text">
					...
					aprimoramento técnico e legal, buscando sempre o crescimento pessoal e
					profissional, através de cursos de atualização e especialização
					constantes. Atuamos também como Peritos e Assistentes Técnicos. A
					experiência de sua equipe vem ganhando credibilidade junto a um grande
					número de empresas. A GST tem como objetivo básico a preservação e a
					integridade das empresas, promovendo a saúde física e mental do
					trabalhador, bem como a melhoria das condições e ambiente do trabalho.
				</p>
			</div>
		</>
	);
