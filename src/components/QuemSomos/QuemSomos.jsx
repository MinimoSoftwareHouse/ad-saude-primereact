			...
			<div className="grid justify-content-around">
				<div className="col-12 sm:col-12 md:col-4 lg:col-4 p-4">
					<Card
						...
						title={<ServicesTitle />}
						className="card shadow-5 hover:shadow-7 mx-0 border-round-3xl sm:border-round-3xl">
						<div className="m-0 ">
				...
				<div className="col-12 sm:col-12 md:col-4 lg:col-4 p-4">
					<Card
						title={<VisionTitle />}
						className="card shadow-5 hover:shadow-7 mx-0 border-round-3xl sm:border-3xl">
						<div className="m-0">
							<h3 className="card-description">
				...
				<div className="col-12 sm:col-12 md:col-4 lg:col-4 p-4">
					<Card
						title={<ValuesTitle />}
						className="card shadow-5 hover:shadow-7 mx-0 border-radius-3xl sm:border-3xl">
						<div className="m-0">
							<h3 className="card-description">
