		...
		<div className="containerServiços">
			<div className="list">
				<div className="services1">
					...
					<ul className="list">
						<li className="item">PGR - Programa de Gerenciamento de Riscos</li>
						<li className="item">
							PPP - Perfil Profissiográfico Previdenciário
						</li>
						<li className="item">Investigação de Acidente do Trabalho</li>
						<li className="item">OSS - Ordem de Serviços de Segurança</li>
						<li className="item">Prontuário de NR 20</li>
						<li className="item">
							Elaboração de LTCAT- Laudo Técnico de Condições Ambientais do
							Trabalho
						</li>
						<li className="item">Avaliações Ambientais</li>
						<li className="item">Treinamentos</li>
						<li className="item">Informe do e-Social - Eventos de SST</li>
						<li className="item">Acompanhamento de Perícias</li>
					</ul>
				</div>
